...
import FactEjecInd from './EjecIndFactura';
import ComisionEjecInd from './EjecIndComision';


function ModalEjecInd() {
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50">
          <div className="bg-gray-50 w-9/12 rounded-lg p-4 shadow-lg">
            ...
            {activeTable === 'Comisión' ? <ComisionEjecInd/> : <FactEjecInd/>}
            <button
              onClick={toggleModal}
